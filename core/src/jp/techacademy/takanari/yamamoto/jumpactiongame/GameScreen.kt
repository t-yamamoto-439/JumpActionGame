package jp.techacademy.takanari.yamamoto.jumpactiongame
...
import jp.techacademy.takanari.yamamoto.jumpactiongame.jp.techacademy.takanari.yamamoto.jumpactiongame.Enemy
import java.util.*
...
class GameScreen(private val mGame: JumpActionGame) : ScreenAdapter() {
    companion object {
        ...
        // 重力
        val GRAVITY = -12
        var sound = Gdx.audio.newSound(Gdx.files.internal("hit.mp3"))
    }
